...
export function MLTechnologiesSkeleton() {
  return (
    <section className="py-20 animate-pulse">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <div className="h-6 w-40 bg-primary/10 rounded-full mx-auto mb-4"></div>
          <div className="h-10 bg-gray-700/20 rounded-lg w-3/4 mx-auto mb-6"></div>
          <div className="h-6 bg-gray-700/10 rounded-lg mb-10 max-w-3xl mx-auto"></div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[1, 2, 3].map((i) => (
            ...
            >
              ...
              <div className="h-7 bg-gray-700/20 rounded mb-3 w-3/4"></div>
...
export function MLFrameworksSkeleton() {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[1, 2].map((i) => (
            <div
              ...
              className="glass-card rounded-2xl overflow-hidden shadow-xl border border-white/5 p-8"
            >
              <div className="h-40 bg-gray-700/10 rounded mb-6"></div>
              <div className="h-6 w-24 bg-primary/10 rounded-full mb-4"></div>
              <div className="h-7 bg-gray-700/20 rounded mb-3"></div>
              <div className="h-16 bg-gray-700/10 rounded mb-6"></div>
              <div className="flex justify-between items-center">
                <div className="h-5 w-24 bg-gray-700/10 rounded"></div>
                <div className="h-10 w-10 bg-primary/10 rounded-full"></div>
              </div>
            </div>
          ))}
        </div>
