...
const LeadershipSection = ({ leadershipTeam }: { leadershipTeam: any[] }) => (
...
const TeamStructureSection = ({ teamMembers }: { teamMembers: any[] }) => (
  ...
  try {
    ...
    return (
      <div className="min-h-screen animate-fadeIn">
        ...
        >
          <TeamStructureSection teamMembers={teamMembers} />
        </Suspense>
