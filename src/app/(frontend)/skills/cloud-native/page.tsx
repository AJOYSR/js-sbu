    ...
    <div className="min-h-screen py-16 animate-fadeIn">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto mb-16 text-center">
          <h1 className="text-4xl font-bold mb-6 text-gradient">Cloud Native Apps</h1>
        ...
        <div className="mb-20 animation-delay-400 animate-fadeIn">
          <h2 className="text-3xl font-bold mb-12 text-center text-gradient">Core Technologies</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {cloudServices.map((service, index) => (
              ...
              >
                ...
                <h5 className="font-semibold text-sm text-primary mb-2">Popular Tools:</h5>
