            ...
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex items-start gap-6">
                ...
                <div className="glass-card p-6 rounded-xl flex-1 border border-white/5">
                  ...
                  <div className="h-4 bg-gray-700/10 rounded-lg mb-4 w-5/6"></div>
                  <div className="space-y-2">
                    {[1, 2, 3, 4].map((j) => (
                      <div key={j} className="flex items-center">
                        <div className="h-1 w-1 bg-primary/20 rounded-full mr-2"></div>
                        <div className="h-3 bg-gray-700/10 rounded-lg w-1/2"></div>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="glass-card rounded-2xl p-8 border border-white/5">
              <div className="w-14 h-14 bg-primary/10 rounded-2xl mb-6"></div>
              <div className="h-6 bg-gray-700/10 rounded-lg mb-3 w-2/3"></div>
