...
export interface Portfolio {
  ...
  image: number | Media;
  category: 'web-application' | 'mobile-development' | 'machine-learning-ai' | 'ui-ux-design';
  technologies: {
    tech: string;
    id?: string | null;
  }[];
...
export interface Partner {
  ...
  logo: number | Media;
  /**
   * The full URL to the partner's website
   */
  website?: string | null;
  /**
   * Check this to display this partner in the "Trusted By" section
   */
  featured?: boolean | null;
  /**
   * Use this to control the display order in the partners list
   */
  order?: number | null;
  updatedAt: string;
  createdAt: string;
